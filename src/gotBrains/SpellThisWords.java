...
public class SpellThisWords {
    String[] wordsEasy = {"Ball", "Wood", "Fond", "Nine", "Home", "Girl", "Fish", "Hell", "Five", "Hope",
            ...
            "Size", "Next", "Oval", "Hack", "Diss", "Fold", "Fury", "Sofa", "Numb", "Joke", "Eggs", "Comb",
            "Whip", "Calf", "Monk", "Tomb", "Navy", "Apex", "Twin", "Pump", "Hulk", "Bulk", "Swim", "Dumb", "Pill",
            "Lens", "Quiz", "Geek", "Halo", "Howl", "Mime", "Debt", "Pulp", "Term", "Feud", "Rich"};

    String[] wordsMedium = {"Purple", "Twelve", "Samsung", "Heaven", "Banana", "Africa", "People", "Snitch",
    ...
    String[] wordsHard = {"Valkyire", "Football", "Strength", "February", "Building", "Calendar",
            "November", "Everything", "Basketball", "Technology", "Watermelon", "Champion", "Hospital", "Chocolate",
            "Friendship", "Medicine", "University", "Blackboard", "Whiteboard", "Mountain", "Umbilical",
    ...
    public void populateLists() {
        for (int i = 0; i < wordsEasy.length - 1; i++) {
            easyWords.add(wordsEasy[i]);
        }
        for (int i = 0; i < wordsMedium.length - 1; i++) {
